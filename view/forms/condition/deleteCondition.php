	...
	<center>
		<form action="../../../controller/app_controller/controller.php" method="POST"> 
			<div class="form-group">
				<label for="exampleIdCondition">Cod - Nombre</label>
				<select class="form-control" id="exampleIdCondition" name="identifier" required>
					...
					<small id="exampleIdCondition" class="form-text text-muted">Seleccione la condicion que desea eliminar.</small>
					<br>
				</div>
				<button type="submit" name="trigger" value="deleteCondition" class="btn btn-primary">Eliminar</button>
			</form>
