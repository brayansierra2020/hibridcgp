 ...
 * 
 */
class ControllerDedicatedTmov{
	public static function saveTmov() {
		require_once ('../connection/connection.php');

		$name_tmov = strtoupper(@$_POST["tmov"]);

		try {

			$sql = "INSERT INTO tipo_movimiento (id_condicion, nombre_condicion) VALUES (null, '$name_condition')";
			$conn->query($sql);
			$conn->commit();
